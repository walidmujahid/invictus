...
public class DriveTrain extends Subsystem {
    ...
    private final WPI_TalonSRX rightFrontDriveRD1 = RobotMap.driveTrainRightFrontDriveRD1;
    private final WPI_TalonSRX rightRearDriveRD2 = RobotMap.driveTrainRightRearDriveRD2;
    private final SpeedControllerGroup rightDrive = RobotMap.driveTrainRightDrive;
    private final WPI_TalonSRX leftFrontDriveLD1 = RobotMap.driveTrainLeftFrontDriveLD1;
    private final WPI_TalonSRX leftRearDriveLD2 = RobotMap.driveTrainLeftRearDriveLD2;
